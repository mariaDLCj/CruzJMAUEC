        ...
        <div class="container mt-5">
            ...
            <form method="post" action="${contexto}/Delete">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control" id="id" name="id" value="${sessionScope.profesorEliminar.codigo.id}" readonly>
                </div>

                <div class="mb-3">
                    <label class="form-label">Tipo</label>
                    <input type="text" class="form-control" id="tipo" name="tipo"  value="${sessionScope.profesorEliminar.codigo.tipo}" readonly>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="apellido2" value="${sessionScope.profesorEliminar.escala}" id="escala" class="form-control" readonly>
                </div>

                <div class="mb-3">
                    <label class="form-label fw-bold">Fecha</label>
                    <input type="text" name="fechaFormateada" value="${sessionScope.profesorEliminar.fechaFormateada}" id="fecha" class="form-control" readonly>
                </div>
